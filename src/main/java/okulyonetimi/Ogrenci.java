...
public class Ogrenci {
    ...
    static Map<String, OgrenciPojo> ogrenciListesi = new HashMap<>();
    ...
    public static void ogrenciMenu() {
        System.err.println("--------------# OGRENCİ SAYFASİ #-----------");
    ...
    public static void ekleme() {
        System.out.println("---------------------------# OGRENCİ EKLEME SAYFASİ #---------------------------------");

        System.out.println();
        System.out.println("Eklemek istediginiz ogrencinin kimlik numrasini giriniz.");
        String kimlikNumarasi = input.next();


        if (kimlikNumarasi.matches("[0-9]{6}")) {
            System.out.println("Eklemek istediginiz ogrencinin adi giriniz");
            String ad = input.next();


            System.out.println("Eklemek istediginiz ogrencinin soyadi giriniz");
            String soyad = input.next();
            System.out.println("Eklemek istediginiz ogrencinin yasini giriniz");
            ...
            try {
                ...
                do {
                    switch (yas) {
                        ...
                        case 18:
                            ...
                            break;
                        default:
                            System.out.println("Okulumuz yabanci dille egitim veren bir kurumdur. \n" +
                ...
                System.out.println("Ogrenci eklemeye devam etmek icin 1'e basiniz\n" +
    ...
    public static void listeleme() {
        ...
        System.err.println("---------------------------# OGRENCİ LİSTESİ #--------------------------------------------------------");
        System.out.println("Kimlik No           Ad                 Soyad              Yas                OgrenciNo          Sinif" +
                "\n-----------------------------------------------------------------------------------------------------------------");
        ...
        System.out.println("Ogrenci menusune donmek icin 1'ye basiniz\n" +
                "Anasayfaya donmek icin baska herhangi bir tusa basiniz");
    ...
    public static void silme() {
        System.err.println("---------------------------# OGRENCİ SILME SAYFASİ #--------------------------------------------------------");
        ...
        if (kimlikNumaralariSet1.contains(ogrenciSilmeSecim)) {
            System.out.println("Silinecek ogrenci bilgilerli: ");
            System.out.println("Kimlik No          Ad           Soyad         Yas          OgrenciNo       Sinif" +
                    "\n-------------------------------------------------------------------------------------------------");
            ...
            System.out.println("Ogrenci silmeye devam etmek icin 1'e basiniz.\n " +
                    "Ogrenci menusune donmek icin 2'ye basiniz\n" +
                    "Anasayfaya donmek icin baska herhangi bir tusa basiniz");
